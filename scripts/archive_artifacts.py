...
def make_rel_archive(a_args):
    ...
    archive.write(os.path.join(v_pwd, "SkyrimProjectGlossary.ini"), "SKSE/Plugins/SkyrimProjectGlossary.ini")
    archive.write(os.path.join(v_pwd, "flash", "build", "GlossaryMenu.swf"), "Interface/GlossaryMenu.swf")
